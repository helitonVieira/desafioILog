...
public class FuncionarioService {
	...
	public Funcionario fromDTO(FuncionarioDTO objDto) {
		Funcionario fornec = new Funcionario(null, objDto.getNome(),objDto.getTelefone(),objDto.getEndereco(),objDto.getDtaAdmissao());
	...
	public Iterable<Funcionario> showAllSubcategorias(){
		return repo.findAll();
	} 
